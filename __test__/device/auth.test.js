...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Chyna89',
      password: 'wXVvpHqHrj7lKB1',
      email: 'Ila52@hotmail.com',
      name: 'Antonio Hettinger',
      userType: 713,
      x: 727,
      y: 66,
      mobileNo: '(016) 881-9379',
      resetPasswordLink: {},
      loginRetryLimit: 710,
      loginReactiveTime: '2024-11-18T15:48:39.175Z',
      id: '65c38bf6258bc038b74eb1f6'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Delia_Vandervort31',
        'password':'Rx8ueS6N4GGMkyV',
        'email':'Abel96@yahoo.com',
        'name':'Johnnie VonRueden',
        'userType':authConstant.USER_TYPES.User,
        'x':161,
        'y':613,
        'mobileNo':'(878) 483-6233',
