...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Roslyn5',
      password: 'nVMV48P_BjLd42c',
      email: 'Krista_Osinski2@hotmail.com',
      name: 'Nathan Dooley',
      userType: 122,
      x: 516,
      y: 693,
      mobileNo: '(571) 504-1207',
      resetPasswordLink: {},
      loginRetryLimit: 296,
      loginReactiveTime: '2024-08-16T10:59:53.263Z',
      id: '65c38bf6258bc038b74eb1b4'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Carlie.Abshire',
        'password':'ZCnidpYBvlssaNd',
        'email':'Lora44@yahoo.com',
        'name':'Natasha Rutherford',
        'userType':authConstant.USER_TYPES.Admin,
        'x':222,
        'y':71,
        'mobileNo':'(729) 508-0325',
